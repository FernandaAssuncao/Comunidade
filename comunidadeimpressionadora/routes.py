...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submit_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha.data):
            ...
            flash(f'Login feito com sucesso no e-maill: {form_login.email.data}', 'alert-success')
    ...
    if form_criarconta.validate_on_submit() and 'botao_submit_criar_conta' in request.form:
        ...
        flash(f'Conta criada com sucesso no e-maill: {form_criarconta.email.data}', 'alert-success')
        return redirect(url_for('home'))
    return render_template('login.html', form_login=form_login, form_criar_conta=form_criarconta)
